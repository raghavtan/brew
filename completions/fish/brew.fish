...
# regenerate-uuid subcommand options
...
__fish_brew_complete_sub_arg 'bundle' 'install' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'install' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'install' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'install' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'install' -l describe -d '`dump` adds a description comment above each line, unless the dependency does not have a description. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'install' -l file= -d 'Read from the `Brewfile` from this location'
...
__fish_brew_complete_sub_arg 'bundle' 'install' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'install' -l global -d 'Read from the global Brewfile'
__fish_brew_complete_sub_arg 'bundle' 'install' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'install' -l install -d 'Run `install` before continuing to other operations e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'install' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'install' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
__fish_brew_complete_sub_arg 'bundle' 'install' -l no-upgrade -d 'Don'
__fish_brew_complete_sub_arg 'bundle' 'install' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'install' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'install' -l services -d 'Temporarily start services while running the `exec` or `sh` command'
__fish_brew_complete_sub_arg 'bundle' 'install' -l tap -d '`list` or `dump` Homebrew tap dependencies'
...
__fish_brew_complete_sub_arg 'bundle' 'install' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'install' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'install' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
# dump subcommand options
__fish_brew_complete_sub_arg 'bundle' 'dump' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l describe -d 'Add a description comment above each line'
...
__fish_brew_complete_sub_arg 'bundle' 'dump' -l file= -d 'Write to the `Brewfile` at this location'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l force -d 'Overwrite an existing `Brewfile`'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l global -d 'Write to the global Brewfile'
...
__fish_brew_complete_sub_arg 'bundle' 'dump' -l no-restart -d 'Don'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. This is enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l services -d 'Temporarily start services while running the `exec` or `sh` command'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l tap -d '`list` or `dump` Homebrew tap dependencies'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
# cleanup subcommand options
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l describe -d '`dump` adds a description comment above each line, unless the dependency does not have a description. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l file= -d 'Read from the `Brewfile` from this location'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l force -d 'Actually perform the cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l global -d 'Read from the global Brewfile'
...
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. This is enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l services -d 'Temporarily start services while running the `exec` or `sh` command'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l tap -d '`list` or `dump` Homebrew tap dependencies'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l zap -d 'Use `zap` command instead of `uninstall` for casks'
# check subcommand options
__fish_brew_complete_sub_arg 'bundle' 'check' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'check' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'check' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'check' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'check' -l describe -d '`dump` adds a description comment above each line, unless the dependency does not have a description. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'check' -l file= -d 'Read from the `Brewfile` from this location'
__fish_brew_complete_sub_arg 'bundle' 'check' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'check' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'check' -l global -d 'Read from the global Brewfile'
...
__fish_brew_complete_sub_arg 'bundle' 'check' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'check' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
__fish_brew_complete_sub_arg 'bundle' 'check' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. This is enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'check' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'check' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'check' -l services -d 'Temporarily start services while running the `exec` or `sh` command'
__fish_brew_complete_sub_arg 'bundle' 'check' -l tap -d '`list` or `dump` Homebrew tap dependencies'
__fish_brew_complete_sub_arg 'bundle' 'check' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'check' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'check' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'check' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'check' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
# exec subcommand options
__fish_brew_complete_sub_arg 'bundle' 'exec' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l describe -d '`dump` adds a description comment above each line, unless the dependency does not have a description. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'exec' -l file= -d 'Read from the `Brewfile` from this location'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l global -d 'Read from the global Brewfile'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l install -d 'Run `install` before continuing'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. This is enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l services -d 'Temporarily start services'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l tap -d '`list` or `dump` Homebrew tap dependencies'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
# list subcommand options
__fish_brew_complete_sub_arg 'bundle' 'list' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'list' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'list' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'list' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'list' -l describe -d '`dump` adds a description comment above each line, unless the dependency does not have a description. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'list' -l file= -d 'Read from the `Brewfile` from this location'
__fish_brew_complete_sub_arg 'bundle' 'list' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'list' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'list' -l global -d 'Read from the global Brewfile'
...
__fish_brew_complete_sub_arg 'bundle' 'list' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
__fish_brew_complete_sub_arg 'bundle' 'list' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. This is enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'list' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'list' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'list' -l services -d 'Temporarily start services while running the `exec` or `sh` command'
__fish_brew_complete_sub_arg 'bundle' 'list' -l tap -d '`list` or `dump` Homebrew tap dependencies'
__fish_brew_complete_sub_arg 'bundle' 'list' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'list' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'list' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'list' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'list' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'list' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
# sh subcommand options
__fish_brew_complete_sub_arg 'bundle' 'sh' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l describe -d '`dump` adds a description comment above each line, unless the dependency does not have a description. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'sh' -l file= -d 'Read from the `Brewfile` from this location'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l global -d 'Read from the global Brewfile'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l install -d 'Run `install` before continuing'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. This is enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l services -d 'Temporarily start services'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l tap -d '`list` or `dump` Homebrew tap dependencies'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
# env subcommand options
__fish_brew_complete_sub_arg 'bundle' 'env' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'env' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'env' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'env' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'env' -l describe -d '`dump` adds a description comment above each line, unless the dependency does not have a description. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'env' -l file= -d 'Read from the `Brewfile` from this location'
__fish_brew_complete_sub_arg 'bundle' 'env' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'env' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'env' -l global -d 'Read from the global Brewfile'
__fish_brew_complete_sub_arg 'bundle' 'env' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'env' -l install -d 'Run `install` before continuing'
__fish_brew_complete_sub_arg 'bundle' 'env' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'env' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
__fish_brew_complete_sub_arg 'bundle' 'env' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. This is enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'env' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'env' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'env' -l services -d 'Temporarily start services while running the `exec` or `sh` command'
__fish_brew_complete_sub_arg 'bundle' 'env' -l tap -d '`list` or `dump` Homebrew tap dependencies'
__fish_brew_complete_sub_arg 'bundle' 'env' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'env' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'env' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'env' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'env' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'env' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
# edit subcommand options
__fish_brew_complete_sub_arg 'bundle' 'edit' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l cask -d '`list` or `dump` Homebrew cask dependencies'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. This is enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l describe -d '`dump` adds a description comment above each line, unless the dependency does not have a description. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'edit' -l file= -d 'Edit the `Brewfile` at this location'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l formula -d '`list` or `dump` Homebrew formula dependencies'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l global -d 'Edit the global Brewfile'
...
__fish_brew_complete_sub_arg 'bundle' 'edit' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. This is enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l no-vscode -d '`dump` without VSCode (and forks/variants) extensions. This is enabled by default if `$HOMEBREW_BUNDLE_DUMP_NO_VSCODE` is set'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l services -d 'Temporarily start services while running the `exec` or `sh` command'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l tap -d '`list` or `dump` Homebrew tap dependencies'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l vscode -d '`list` or `dump` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l whalebrew -d '`list` or `dump` Whalebrew dependencies'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
...
# list subcommand options
__fish_brew_complete_sub_arg 'services' 'list' -l all -d 'Run subcommand on all services'
__fish_brew_complete_sub_arg 'services' 'list' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'services' 'list' -l file -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'list' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'services' 'list' -l json -d 'Output as JSON'
__fish_brew_complete_sub_arg 'services' 'list' -l keep -d 'When stopped, don\'t unregister the service from launching at login (or boot)'
__fish_brew_complete_sub_arg 'services' 'list' -l max-wait -d 'Wait at most this many seconds for `stop` to finish stopping a service. Omit this flag or set this to zero (0) seconds to wait indefinitely'
__fish_brew_complete_sub_arg 'services' 'list' -l no-wait -d 'Don\'t wait for `stop` to finish stopping the service'
__fish_brew_complete_sub_arg 'services' 'list' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'services' 'list' -l sudo-service-user -d 'When run as root on macOS, run the service(s) as this user'
__fish_brew_complete_sub_arg 'services' 'list' -l verbose -d 'Make some output more verbose'
# info subcommand options
__fish_brew_complete_sub_arg 'services' 'info' -l all -d 'Run on all services'
__fish_brew_complete_sub_arg 'services' 'info' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'services' 'info' -l file -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'info' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'services' 'info' -l json -d 'Output as JSON'
__fish_brew_complete_sub_arg 'services' 'info' -l keep -d 'When stopped, don\'t unregister the service from launching at login (or boot)'
__fish_brew_complete_sub_arg 'services' 'info' -l max-wait -d 'Wait at most this many seconds for `stop` to finish stopping a service. Omit this flag or set this to zero (0) seconds to wait indefinitely'
__fish_brew_complete_sub_arg 'services' 'info' -l no-wait -d 'Don\'t wait for `stop` to finish stopping the service'
__fish_brew_complete_sub_arg 'services' 'info' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'services' 'info' -l sudo-service-user -d 'When run as root on macOS, run the service(s) as this user'
__fish_brew_complete_sub_arg 'services' 'info' -l verbose -d 'Output more detailed information'
# run subcommand options
__fish_brew_complete_sub_arg 'services' 'run' -l all -d 'Run on all services'
...
__fish_brew_complete_sub_arg 'services' 'run' -l json -d 'Output as JSON'
__fish_brew_complete_sub_arg 'services' 'run' -l keep -d 'When stopped, don\'t unregister the service from launching at login (or boot)'
__fish_brew_complete_sub_arg 'services' 'run' -l max-wait -d 'Wait at most this many seconds for `stop` to finish stopping a service. Omit this flag or set this to zero (0) seconds to wait indefinitely'
__fish_brew_complete_sub_arg 'services' 'run' -l no-wait -d 'Don\'t wait for `stop` to finish stopping the service'
...
__fish_brew_complete_sub_arg 'services' 'run' -l verbose -d 'Output more detailed information'
# start subcommand options
__fish_brew_complete_sub_arg 'services' 'start' -l all -d 'Run on all services'
__fish_brew_complete_sub_arg 'services' 'start' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'services' 'start' -l file -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'start' -l file= -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'start' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'services' 'start' -l json -d 'Output as JSON'
__fish_brew_complete_sub_arg 'services' 'start' -l keep -d 'When stopped, don\'t unregister the service from launching at login (or boot)'
__fish_brew_complete_sub_arg 'services' 'start' -l max-wait -d 'Wait at most this many seconds for `stop` to finish stopping a service. Omit this flag or set this to zero (0) seconds to wait indefinitely'
__fish_brew_complete_sub_arg 'services' 'start' -l no-wait -d 'Don\'t wait for `stop` to finish stopping the service'
__fish_brew_complete_sub_arg 'services' 'start' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'services' 'start' -l sudo-service-user -d 'When run as root on macOS, run the service(s) as this user'
__fish_brew_complete_sub_arg 'services' 'start' -l verbose -d 'Output more detailed information'
# stop subcommand options
__fish_brew_complete_sub_arg 'services' 'stop' -l all -d 'Run on all services'
__fish_brew_complete_sub_arg 'services' 'stop' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'services' 'stop' -l file -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'stop' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'services' 'stop' -l json -d 'Output as JSON'
__fish_brew_complete_sub_arg 'services' 'stop' -l keep -d 'When stopped, don'
__fish_brew_complete_sub_arg 'services' 'stop' -l max-wait -d 'Wait at most this many seconds for `stop` to finish stopping a service. Omit this flag or set this to zero (0) seconds to wait indefinitely'
__fish_brew_complete_sub_arg 'services' 'stop' -l max-wait= -d 'Wait at most this many seconds for `stop` to finish stopping a service. '
__fish_brew_complete_sub_arg 'services' 'stop' -l no-wait -d 'Don'
__fish_brew_complete_sub_arg 'services' 'stop' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'services' 'stop' -l sudo-service-user -d 'When run as root on macOS, run the service(s) as this user'
__fish_brew_complete_sub_arg 'services' 'stop' -l verbose -d 'Output more detailed information'
# kill subcommand options
__fish_brew_complete_sub_arg 'services' 'kill' -l all -d 'Run on all services'
__fish_brew_complete_sub_arg 'services' 'kill' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'services' 'kill' -l file -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'kill' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'services' 'kill' -l json -d 'Output as JSON'
__fish_brew_complete_sub_arg 'services' 'kill' -l keep -d 'When stopped, don\'t unregister the service from launching at login (or boot)'
__fish_brew_complete_sub_arg 'services' 'kill' -l max-wait -d 'Wait at most this many seconds for `stop` to finish stopping a service. Omit this flag or set this to zero (0) seconds to wait indefinitely'
__fish_brew_complete_sub_arg 'services' 'kill' -l no-wait -d 'Don\'t wait for `stop` to finish stopping the service'
__fish_brew_complete_sub_arg 'services' 'kill' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'services' 'kill' -l sudo-service-user -d 'When run as root on macOS, run the service(s) as this user'
__fish_brew_complete_sub_arg 'services' 'kill' -l verbose -d 'Output more detailed information'
# restart subcommand options
__fish_brew_complete_sub_arg 'services' 'restart' -l all -d 'Run on all services'
__fish_brew_complete_sub_arg 'services' 'restart' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'services' 'restart' -l file -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'restart' -l file= -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'restart' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'services' 'restart' -l json -d 'Output as JSON'
__fish_brew_complete_sub_arg 'services' 'restart' -l keep -d 'When stopped, don\'t unregister the service from launching at login (or boot)'
__fish_brew_complete_sub_arg 'services' 'restart' -l max-wait -d 'Wait at most this many seconds for `stop` to finish stopping a service. Omit this flag or set this to zero (0) seconds to wait indefinitely'
__fish_brew_complete_sub_arg 'services' 'restart' -l no-wait -d 'Don\'t wait for `stop` to finish stopping the service'
__fish_brew_complete_sub_arg 'services' 'restart' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'services' 'restart' -l sudo-service-user -d 'When run as root on macOS, run the service(s) as this user'
__fish_brew_complete_sub_arg 'services' 'restart' -l verbose -d 'Output more detailed information'
# cleanup subcommand options
__fish_brew_complete_sub_arg 'services' 'cleanup' -l all -d 'Run subcommand on all services'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l file -d 'Use the service file from this location to `start` the service'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l json -d 'Output as JSON'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l keep -d 'When stopped, don\'t unregister the service from launching at login (or boot)'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l max-wait -d 'Wait at most this many seconds for `stop` to finish stopping a service. Omit this flag or set this to zero (0) seconds to wait indefinitely'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l no-wait -d 'Don\'t wait for `stop` to finish stopping the service'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l sudo-service-user -d 'When run as root on macOS, run the service(s) as this user'
__fish_brew_complete_sub_arg 'services' 'cleanup' -l verbose -d 'Make some output more verbose'
