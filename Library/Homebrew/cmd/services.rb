    ...
    class Services < AbstractCommand
      cmd_args do
        usage_banner <<~EOS
          ...
          If `--new-system` is passed or the environment variable `HOMEBREW_USE_NEW_SUBCOMMAND_SYSTEM` is set,
          use the new subcommand system implementation.
        EOS
